...
function agregarExtras(){
    if (datosDelServicio.barraTragos == "si"){
        serviciosContratados.agregarServicio(new Servicio("Barra de Tragos", 4500));
    } 

    if (datosDelServicio.vajilla == "si"){
        serviciosContratados.agregarServicio(new Servicio("Vajilla de Color", 2500));
    }

    if (datosDelServicio.mesaDulce == "si"){
        serviciosContratados.agregarServicio(new Servicio("Mesa Dulce", 3000));
    }
}
